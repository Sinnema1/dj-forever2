...
| SO-011 | Dependency Risk    | Dependency audit/scanning cadence is defined                                    | [x] Pass [ ] Fail |          | .github/workflows/ci.yml enforces `npm audit --omit=dev --audit-level=high` for server/client; full-tree audits remain informational |
