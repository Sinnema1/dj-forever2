...
| DGF-003 | DG-011     | Placeholder tokens remain across active docs                | Medium   | Ambiguity in execution guidance and governance drift risk | Justin Manning | 2026-03-23  | Validated | npm run audit:docs:check shows Placeholder markers (active docs): 0; updates in docs/admin/ANALYTICS_DASHBOARD_IMPLEMENTATION.md, docs/admin/GUEST_MANAGEMENT_IMPLEMENTATION.md, docs/wedding/weddingTracker/sheet1.md, docs/wedding/weddingTracker/sheet2.md, docs/wedding/wedding_contract.md, docs/features/QR_ALIAS_FEATURE_GUIDE.md, docs/development/QR_ALIAS_IMPLEMENTATION.md, docs/UI_ENHANCEMENTS_BACKLOG.md | Closed in remediation pass 2                |
