      ...
      <div className="rsvp-confirmation-card">
        ...
        <div className="confirmation-content">
          <h2 className="confirmation-title">
            {isAttending ? "We can't wait to celebrate with you!" : "Thank you for letting us know"}
          </h2>
          ...
          <div className="confirmation-details">
            ...
            <p className="confirmation-detail">
              <strong>Attendance:</strong> {isAttending ? "Will be attending" : "Will not be attending"}
            </p>
            ...
            {isAttending ? (
              <>
                <p className="next-steps-text">
                  ...
                  If you need to make any changes, you can update your RSVP anytime.
                </p>
              ...
              <p className="next-steps-text">
                We understand you can't make it, but we'll miss you on our special day! 
                Feel free to browse our photo gallery after the wedding.
              </p>
            )}
          </div>
